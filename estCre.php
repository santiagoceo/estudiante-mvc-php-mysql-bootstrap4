<?php
    ...
    //$departamento = $objDepartamento->consultar($conexion);
...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        ...
        <ul class="nav nav-pills">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item active" href="estCre.php">Crear </a>
    ...
    <div class="container text-center">
        ...
        <p class="lead">Para crear un estudiante completa todos los campos a continuación</p>
    </div>
    <div class="container pb-3">
        <div class="row">
        <div class="col"></div>
            <div class="col">
            <form action="controlador/estCre.php" method="post">
                ...
                <div class="form-group text-center">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1" name="idMunicipio">
                        <?php
                        while($nombrem = mysqli_fetch_array($municipio)){
                        ?>
