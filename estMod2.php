<?php
    ...
    while ($datos = mysqli_fetch_array($estudiante)) {
        $id = $datos['idEstudiante'];
        $nombre = $datos['Nombre estudiante'];
        $apellido = $datos['Apellido estudiante'];
        ...
        $nombreAcudiente = $datos['Nombre acudiente'];
        $apellidoAcudiente = $datos['Apellido acudiente'];
    }
...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        ...
        <ul class="nav nav-pills">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item active" href="estMod.php">Modificar </a>
            ...
            <form action="controlador/estMod.php" method="post">
                ...
                <div class="form-group text-center">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1" name="idAcudiente">
                        ...
                        <?php 
                        if ($acudientem['idAcudiente']==$idAcudiente){
                        ?>
                        selected 
                        <?php
                        }
