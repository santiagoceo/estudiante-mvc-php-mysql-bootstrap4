...
CREATE TABLE `acudiente` (
  ...
  CONSTRAINT `acudiente_ibfk_1` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`)
...
INSERT INTO `acudiente` VALUES (1,'n1','a1','2018-09-01',11,'dir1',381),(2,'n2','a2','2018-09-19',123,'direccioooon',107),(3,'nnn','aaa','0000-00-00',111,'dir',10),(4,'nnn','aaa','2000-10-10',111,'dir',10),(10,'njk','njkln','1970-01-01',1,'11',1),(14,'nn','aa','2010-10-10',3213,'1231',1),(15,'Nombre','Apellido','2018-09-12',3123,'Direccion',15),(16,'Nombre','Apellido','2018-09-12',3123,'Direccion',15),(17,'Nombre','Apellido','2018-09-13',3123123,'Dorrr',68);
...
CREATE TABLE `estudiante` (
  ...
  CONSTRAINT `estudiante_ibfk_1` FOREIGN KEY (`idAcudiente`) REFERENCES `acudiente` (`idAcudiente`)
...
INSERT INTO `estudiante` VALUES (6,'Javier','Santiago','1990-06-20',923,1),(7,'Nooo','Appp','1970-01-01',57,15),(8,'Pepe','Pepa','1970-01-01',0,1),(9,'dsa','das','1970-01-01',1,1),(10,'dsa','das','0000-00-00',1,1),(11,'dsa','das','1111-01-01',1,1),(13,'Peppa','Pig','1990-09-11',923,1),(15,'Willi','Wonka','2018-09-06',19,1);
...
--
-- Temporary table structure for view `vistaacudiente`
--

DROP TABLE IF EXISTS `vistaacudiente`;
/*!50001 DROP VIEW IF EXISTS `vistaacudiente`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vistaacudiente` (
  `idAcudiente` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vistacudiente`
--

DROP TABLE IF EXISTS `vistacudiente`;
/*!50001 DROP VIEW IF EXISTS `vistacudiente`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vistacudiente` (
  `nombre` tinyint NOT NULL,
  `apellido` tinyint NOT NULL,
  `fechaNacimiento` tinyint NOT NULL,
  `tel` tinyint NOT NULL,
...
--
-- Temporary table structure for view `vistadepartamento`
--

DROP TABLE IF EXISTS `vistadepartamento`;
/*!50001 DROP VIEW IF EXISTS `vistadepartamento`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vistadepartamento` (
...
--
-- Temporary table structure for view `vistaestudiante`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vistaestudiante` (
  `Id` tinyint NOT NULL,
  `Nombre` tinyint NOT NULL,
  `Apellido` tinyint NOT NULL,
  `Fecha nacimiento` tinyint NOT NULL,
  `Municipio` tinyint NOT NULL,
  `Departamento` tinyint NOT NULL,
  `Nombre acudiente` tinyint NOT NULL,
  `Apellido acudiente` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `vistamundep`
--

DROP TABLE IF EXISTS `vistamundep`;
/*!50001 DROP VIEW IF EXISTS `vistamundep`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vistamundep` (
  `departamento` tinyint NOT NULL,
  `municipio` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `vistamunicipio`
--

DROP TABLE IF EXISTS `vistamunicipio`;
/*!50001 DROP VIEW IF EXISTS `vistamunicipio`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vistamunicipio` (
...
--
/*!50003 DROP PROCEDURE IF EXISTS `actualizarAcudienteId` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizarAcudienteId`(IN ide INT(11), nom VARCHAR(45), ape VARCHAR(45), fec DATE, tele INT(15), dir VARCHAR(45), idm INT(11))
BEGIN 
UPDATE acudiente 
SET  nombre = nom, apellido = ape, fechaNacimiento = fec, tel = tele, direccion = dir, id_municipio = idm
WHERE idAcudiente = ide;
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `actualizarEstudianteID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizarEstudianteID`(in estId int(11), nom varchar(45), ape varchar (45), fec date, idm int(6), ida int(11))
BEGIN 
UPDATE estudiante SET nombre = nom, apellido = ape, fechaNacimiento = fec, idMunicipio = idm, idAcudiente = ida WHERE idEstudiante = estID;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `consultarAcudienteId` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultarAcudienteId`(IN ide INT(11))
BEGIN 
SELECT a.idAcudiente, a.nombre, a.apellido, a.fechaNacimiento, a.tel, a.direccion, a.id_municipio, m.municipio FROM acudiente a 
INNER JOIN municipios m ON a.id_municipio = m.id_municipio 
WHERE a.idAcudiente = ide;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `consultarEstudianteId` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consultarEstudianteId`(IN ide INT(11))
BEGIN 
SELECT e.idEstudiante, e.nombre AS 'Nombre estudiante', 
e.apellido AS 'Apellido estudiante', e.fechaNacimiento, m.id_municipio, 
m.municipio, a.idAcudiente, a.nombre AS 'Nombre acudiente', a.apellido AS 'Apellido acudiente' FROM estudiante e 
INNER JOIN municipios m ON e.idMunicipio = m.id_municipio 
INNER JOIN acudiente a ON e.idAcudiente = a.IdAcudiente WHERE e.idEstudiante = ide;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `eliminarAcudienteID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `eliminarAcudienteID`(IN ide INT(11))
BEGIN 
DELETE FROM acudiente WHERE idAcudiente = ide;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `eliminarEstudianteID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `eliminarEstudianteID`(IN ide INT(11))
BEGIN 
DELETE FROM estudiante WHERE idEstudiante = ide;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insertarAcudiente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertarAcudiente`(in nom VARCHAR(45), ape VARCHAR(45), fec DATE, tel INT(15), dir VARCHAR(45), idm INT(6))
BEGIN
	INSERT INTO acudiente (nombre, apellido, fechaNacimiento, tel, direccion, id_municipio) VALUES (nom, ape, fec, tel, dir, idm);
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertarEstudiante`(in nom VARCHAR(45), ape VARCHAR(45), fec DATE, idm INT(6), ida INT(11))
BEGIN
	INSERT INTO estudiante (nombre, apellido, fechaNacimiento, idMunicipio, idAcudiente) VALUES (nom, ape, fec, idm, ida);
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
--
-- Final view structure for view `vistaacudiente`
--

/*!50001 DROP TABLE IF EXISTS `vistaacudiente`*/;
/*!50001 DROP VIEW IF EXISTS `vistaacudiente`*/;
...
/*!50001 VIEW `vistaacudiente` AS select `a`.`idAcudiente` AS `idAcudiente`,`a`.`nombre` AS `nombre`,`a`.`apellido` AS `apellido`,`a`.`fechaNacimiento` AS `fechaNacimiento`,`a`.`tel` AS `tel`,`a`.`direccion` AS `direccion`,`d`.`departamento` AS `departamento`,`m`.`municipio` AS `municipio` from ((`acudiente` `a` join `municipios` `m` on((`a`.`id_municipio` = `m`.`id_municipio`))) join `departamentos` `d` on((`m`.`departamento_id` = `d`.`id_departamento`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vistacudiente`
--

/*!50001 DROP TABLE IF EXISTS `vistacudiente`*/;
/*!50001 DROP VIEW IF EXISTS `vistacudiente`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vistacudiente` AS select `a`.`nombre` AS `nombre`,`a`.`apellido` AS `apellido`,`a`.`fechaNacimiento` AS `fechaNacimiento`,`a`.`tel` AS `tel`,`a`.`direccion` AS `direccion`,`m`.`municipio` AS `municipio` from (`acudiente` `a` join `municipios` `m` on((`a`.`id_municipio` = `m`.`id_municipio`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vistadepartamento`
--

/*!50001 DROP TABLE IF EXISTS `vistadepartamento`*/;
/*!50001 DROP VIEW IF EXISTS `vistadepartamento`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vistadepartamento` AS select `departamentos`.`id_departamento` AS `id_departamento`,`departamentos`.`departamento` AS `departamento` from `departamentos` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 DROP TABLE IF EXISTS `vistaestudiante`*/;
/*!50001 DROP VIEW IF EXISTS `vistaestudiante`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vistaestudiante` AS select `es`.`idEstudiante` AS `Id`,`es`.`nombre` AS `Nombre`,`es`.`apellido` AS `Apellido`,`es`.`fechaNacimiento` AS `Fecha nacimiento`,`mu`.`municipio` AS `Municipio`,`de`.`departamento` AS `Departamento`,`ac`.`nombre` AS `Nombre acudiente`,`ac`.`apellido` AS `Apellido acudiente` from (((`estudiante` `es` join `municipios` `mu` on((`es`.`idMunicipio` = `mu`.`id_municipio`))) join `departamentos` `de` on((`mu`.`departamento_id` = `de`.`id_departamento`))) join `acudiente` `ac` on((`es`.`idAcudiente` = `ac`.`idAcudiente`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vistamundep`
--

/*!50001 DROP TABLE IF EXISTS `vistamundep`*/;
/*!50001 DROP VIEW IF EXISTS `vistamundep`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vistamundep` AS select `d`.`departamento` AS `departamento`,`m`.`municipio` AS `municipio` from (`municipios` `m` join `departamentos` `d` on((`m`.`departamento_id` = `d`.`id_departamento`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vistamunicipio`
--

/*!50001 DROP TABLE IF EXISTS `vistamunicipio`*/;
/*!50001 DROP VIEW IF EXISTS `vistamunicipio`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vistamunicipio` AS select `municipios`.`id_municipio` AS `id_municipio`,`municipios`.`municipio` AS `municipio`,`municipios`.`estado` AS `estado`,`municipios`.`departamento_id` AS `departamento_id` from `municipios` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-09-24 11:09:26
