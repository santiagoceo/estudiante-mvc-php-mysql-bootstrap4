...
<head>
    ...
    <title>Acudiente consultar</title>
...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        ...
        <ul class="nav nav-pills">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item active" href="acuCon.php">Consultar </a>
    ...
    <div class="container text-center">
        <h1>Consulta de Acudientes</h1>
        <p class="lead">A continuación podrás conocer los acudientes registrados en la plataforma</p>
    </div>
    <div class="container">
