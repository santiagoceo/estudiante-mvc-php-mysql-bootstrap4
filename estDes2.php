...
<head>
    ...
    <title>Estudiante eliminar</title>
...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        ...
        <ul class="nav nav-pills">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item active" href="estDes.php">Desactivar/Activar </a>
            </div>
            </li>
            <li class="nav-item dropdown">
    ...
    <div class="container text-center">
        ...
        <p class="lead">Confirma el estudiante a eliminar</p>
    </div>
    <div class="container pb-3">
        <div class="row">
        <div class="col"></div>
            <div class="col">
            <form action="controlador/estDes.php" method="post">
                <div class="form-group text-center">
                    <label for="Nombre">Nombre</label>
                    <input type="hidden" class="form-control" name="id" value="<?php echo $id ?>" required>
                    <input type="text" class="form-control" placeholder="Nombre" name="nombre" value="<?php echo $nombre ?>" disabled required>
                </div>
                <div class="form-group text-center">
                    <label for="Apellido">Apellido</label>
                    <input type="text" class="form-control" placeholder="Apellido" name="apellido" value="<?php echo $apellido ?>" disabled required>
                </div>
                <div class="form-group text-center">
                    <label for="Fecha de nacimiento">Fecha de nacimiento</label>
                    <input type="date" class="form-control" placeholder="Fecha de nacimiento" name="fechaNacimiento" value="<?php echo $fechaNacimiento ?>" disabled required>
                </div>
                <div class="form-group text-center">
                ...
                <div class="form-group text-center">
                    ...
                    <select class="form-control" id="exampleFormControlSelect1" name="idAcudiente" disabled>
